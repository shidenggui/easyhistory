...
class TestHistory(unittest.TestCase):
    def test_get_history(self):
        ...
        res = easyhistroy.day.Day().get_stock_time(test_date)
    ...
    def test_get_quarter_history(self):
        ...
        res = easyhistroy.day.Day().get_quarter_history(*test_data)
        print(res)
    ...
    def test_day_data_type_convert(self):
        ...
        normal_data = ['2016-02-19', 945.019, 949.701, 940.336, 935.653, 31889824.000, 320939648.000, 93.659]
        easyhistroy.day.Day().convert_stock_data_type(test_data)
        self.assertListEqual(test_data, normal_data)

    def test_out_history(self):
        test_data = ['002783']
        easyhistroy.day.Day().out_stock_history(*test_data)
